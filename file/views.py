...
class FileView(APIView):
    ...
    def put(self, request):
        ...
        try:
            file = File.objects.get(file=old_file_name, username=username, workspace=workspace)
        except:
        ...
        if file_serializer.is_valid():
            ...
            current_path = os.getcwd()
            old_name = f'{current_path}/directory/{username}/{workspace}/{old_file_name}'
            new_name = f'{current_path}/directory/{username}/{workspace}/{new_file_name}'
